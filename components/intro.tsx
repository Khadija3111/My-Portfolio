...
export default function Intro() {
  return (
    <section className="px-0 sm:pl-10 flex flex-col-reverse sm:flex-col md:flex-row items-center justify-between gap-x-2 sm:gap-x-10 md:gap-x-19 gap-y-6 pt-14 sm:pt-24 pb-5">
      <div className="mt-1 flex-1 md:mt-0 w-full">
